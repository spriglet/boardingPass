# Generated by Django 2.0.2 on 2018-02-24 23:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_threshold', models.PositiveIntegerField(default=1)),
                ('length_in_minutes', models.PositiveIntegerField(default=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='JPY', max_digits=13)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(default='JPY', max_length=31)),
                ('isSensei', models.BooleanField(default=False)),
                ('timeZone', models.CharField(default='UTC', max_length=31)),
        ...
        migrations.AddField(
            ...
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.TransactionStatus'),
        ),
        migrations.AddField(
            model_name='timeslot',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.TimeSlotStatus'),
        ),
        migrations.AddField(
            model_name='seat',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.SeatStatus'),
        ),
        migrations.AddField(
            model_name='seat',
            name='student',
